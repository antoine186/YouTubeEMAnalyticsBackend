...
def text_divider(article_text, max_characters_allowed):
    ...
    tranches_list.append(article_text[slit_bottom_index:slit_bottom_index + max_characters_allowed])

    slit_bottom_index = slit_bottom_index + max_characters_allowed
